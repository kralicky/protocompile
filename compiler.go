...
func (e *executor) invalidate(files ...string) []string {
	...
	for _, file := range files {
		...
		e.invalidateLocked(r, blocks, invalidated)
	}
...
func (e *executor) invalidateLocked(r *result, blocks map[*result][]*result, seen map[string]struct{}) bool {
	...
	for _, dep := range blocks[r] {
		...
		e.invalidateLocked(dep, blocks, seen)
	}
